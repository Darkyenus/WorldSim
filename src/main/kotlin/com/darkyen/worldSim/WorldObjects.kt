...
enum class Feature(
	...
	CONIFEROUS_FOREST_DEEP(Simple(32), FOOD_SOURCE_WILD_ANIMALS, FOOD_SOURCE_MUSHROOMS, WOOD_SOURCE, WALK_MUCH_SLOWER, CRAFTING_MATERIAL_SOURCE),
	CONIFEROUS_FOREST(Simple(37), FOOD_SOURCE_MUSHROOMS, WOOD_SOURCE, WALK_SLOWER),
	DECIDUOUS_FOREST_DEEP(Simple(32), FOOD_SOURCE_WILD_ANIMALS, FOOD_SOURCE_MUSHROOMS, WOOD_SOURCE, WALK_MUCH_SLOWER, CRAFTING_MATERIAL_SOURCE),
	...
	STONES_SMALL(Simple(94), STONE_SOURCE, WALK_SLOWER),
	STONES_LARGE(Simple(95), STONE_SOURCE, WALK_MUCH_SLOWER),
...
enum class Item(val craftMaterialRequirement:Int = -1) {
	FOOD,
	WOOD,
	STONE,
	CRAFTING_MATERIAL,
	WATER_CANTEEN_EMPTY(craftMaterialRequirement=5),
	WATER_CANTEEN_FULL,
	;
}
